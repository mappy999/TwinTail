...
namespace Twin.Test
{
	...
	public class __HtmlDocument
	{
		...
		public __HtmlDocument(string html)
		{
			// 
		...
		/// HtmlDocumentクラスのインスタンスを初期化
		/// </summary>
		public __HtmlDocument() : this(String.Empty)
		{
		}
		...
		{
			return __HtmlElement.Sta_GetElementsByName(root, tagName.ToUpper());
		}
		...
		{
			return __HtmlElement.Sta_GetElementById(root, id);
		}
